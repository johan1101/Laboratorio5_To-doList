        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form action="SvAnadirBuscar" method="GET" class="d-flex" >
                    <input type="number" class="form-control me-2" type="search" placeholder="Ingrese el id" aria-label="Search" name="buscar" max="999999999" min="0" step="1" oninput="validarLongitud(this)" required>
